...
function absurdBubbleSort(arr, sortCompletionCallback) {
    function outerBubbleSortLoop(madeAnySwaps) {
        ...
        // if madeAnySwaps == true, call innerBubbleSortLoop
        // It should pass in arr, an index of 0, and false to indicate that no swaps have been made.
        ...
        // spassing in arr, which is now sorted!
...
absurdBubbleSort([2, 1, 3, 4, 5, 6], function (arr) {
